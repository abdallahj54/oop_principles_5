...
public class Dinosaur extends Animal{
    ...
    1. if the size:
        * normal -> multiply the damage by 1
        * big    -> multiply the damage by 3
        * giant  -> multiply the damage by 10

    2. if animal hasSpike:
            print "Animal had spikes and the attack was critical!"
       else:
            print "Animal didn't have spikes and the attack was not critical!"
     */
    @Override
    public double attack(){
        ...
        System.out.println(name + " is attacking. It damaged \"" + damage + "\"." +
                "\n" + (hasSpike ? "Animal had spikes and the attack was critical!" : "Animal didn't have spikes and the attack was not critical!"));
    ...
    public double attack(String mood){
        ...
        switch (mood.toLowerCase()){
            ...
            case "calm":
            case "happy":
                System.out.println(name + " is in a good mood and attacks less!");
                damage /= 2;
                break;
            case "angry":
            case "hungry":
                System.out.println(name + " is in a bad mood and attacks more!");
                damage *= 2;
                break;
        }
