...
public class ExtendingChild extends AbstractParent implements OptionalStuff{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sum of var1 and var4: ");
        System.out.println("Var1 = " + abstractParent.var1);
        System.out.println("Var4 = " + abstractParent.var4);
        System.out.println("Sum of var1 and var4 = " + abstractParent.getSumOfVar1And4());

        System.out.println("\nGet first 3 characters in var2:");
        ...
        System.out.println("\nisPhoneOnOrOff() Method: ");
        //System.out.println(abstractParent.isPhoneOnOrOff("")); Object name should be the same as new (BLANK)
